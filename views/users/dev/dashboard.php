...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="views/assets/backend/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/css/vendor.bundle.base.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/font-awesome/css/font-awesome.min.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="views/assets/backend/vendors/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/flag-icon-css/css/flag-icons.min.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/owl-carousel-2/owl.carousel.min.css">
    <link rel="stylesheet" href="views/assets/backend/vendors/owl-carousel-2/owl.theme.default.min.css">
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="views/assets/backend/css/style.css">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="views/assets/backend/images/favicon.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="views/assets/backend/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="views/assets/backend/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="views/assets/backend/images/faces/face15.jpg" alt="">
    ...
    <script src="views/assets/backend/js/jquery.cookie.js" type="text/javascript"></script>
