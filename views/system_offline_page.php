...
<head>
  ...
  <title>Bank · Under Maintenance</title>
  ...
  <style>
    * {
    ...
    .progress-bar-custom::after {
      ...
      left: 0;
      height: 100%;
      width: 60%;  /* fixed progress for visual – under maintenance */
...
<body>
  <div class="maintenance-card text-center">
    ...
    <!-- Subheadline / message -->
    <p class="lead">
      Our banking systems are being upgraded.<br>
    ...
    <!-- Additional small info: 24/7 support, security -->
